...
model_numbers = APIRouter(dependencies=[Depends(JWTBearer())], tags=["equipments"])
...
@model_numbers.get(
    "/api/model_number/{model_number_id}", response_model=ModelNumberSchema
)
...
@model_numbers.get(
    "/api/model_numbers/{model_id}", response_model=List[ModelNumberSchema]
)
...
@model_numbers.put(
    "/api/model_numbers/{model_number_id}", response_model=ModelNumberSchema
)
...
@model_numbers.delete(
    "/api/model_numbers/{model_number_id}", status_code=HTTP_204_NO_CONTENT
)
