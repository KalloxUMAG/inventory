...
class GroupSupplyService:
    ...
    async def add_group_supply(self, group_supply: GroupSupplySchema, db: Session):
    ...
    async def update_quantity(self, relation: GroupSupplySchema, data_update: GroupSupplySchema, db: Session):
